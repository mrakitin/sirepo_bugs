...
varParam = srwl_bl.srwl_uti_ext_options([
    ['name', 's', 'NSLS-II ESM beamline tabulated undulator imported', 'simulation name'],

#---Data Folder
    ['fdir', 's', '', 'folder (directory) name for reading-in input and saving output data files'],

#---Electron Beam
    ['ebm_nm', 's', 'Beam Name', 'standard electron beam name'],
...
#---Undulator
    ...
    ['und_g', 'f', 35.75, 'undulator gap [mm] (assumes availability of magnetic measurement or simulation data)'],
...
#---Calculation Types
    ...
    ['sm_ei', 'f', 400.0, 'initial photon energy [eV] for multi-e spectrum vs photon energy calculation'],
    ['sm_ef', 'f', 1100.0, 'final photon energy [eV] for multi-e spectrum vs photon energy calculation'],
    ['sm_ne', 'i', 500, 'number of points vs photon energy for multi-e spectrum vs photon energy calculation'],
    ...
    #to add options
    ['op_r', 'f', 27.5, 'longitudinal position of the first optical element [m]'],
...
#---User Defined Electron Beam
    ...
    ['ueb_rms_size_x', 'f', 4.263801121e-05, "horizontal RMS size [m]"],
    ['ueb_rms_diverg_x', 'f', 2.110792634e-05, "horizontal RMS divergence [rad]"],
    ['ueb_xxpr_x', 'f', 0.0, "horizontal <(x-<x>)(x'-<x'>)> [m]"],
    ['ueb_rms_size_y', 'f', 2.91204396e-06, "vertical RMS size [m]"],
    ['ueb_rms_diverg_y', 'f', 2.74721128e-06, "vertical RMS divergence [rad]"],
