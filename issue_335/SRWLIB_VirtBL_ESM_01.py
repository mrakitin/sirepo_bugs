...
varParam = [
#---Data Folder
    ['fdir', 's', os.path.join(os.getcwd(), ''), 'folder (directory) name for reading-in input and saving output data files'],
...
#---Electron Beam
    ...
    ['ebm_z', 'f', -0.7, 'electron beam initial average longitudinal position [m]'],
